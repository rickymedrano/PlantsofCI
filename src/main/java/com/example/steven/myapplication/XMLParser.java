...
// to their respective "read" methods for processing. Otherwise, skips the tag.
        private com.example.steven.plantsofci.XMLParser.Entry readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
